...
4. Read initial game state via `DealersMulticall.getFullDealerState(tokenId)`
...
cat > "$DEALERS_STATE_DIR/network.testnet.json" << 'JSON'
{
  ...
  "contracts": {
    "nft":              "0xCa4BC92b565A110952933C90f581A7765415e6Ed",
    "core":             "0x8dC006a61012F1a6f3EAd24eEfaf0e634d0635f4",
    "actions":          "0x407B2507B7371834D7616E3F0A69274124119598",
    "pve":              "0x9D6dc92F71416943aB7ee2653c681dC403107149",
    "pvp":              "0x73551b83d47Fd830d7571b4EB81059Ce92820F68",
    "heists":           "0x36B7941C93E7DaA916dbA0ea42841Fc54CbC2325",
    "boosts":           "0x6bD8B5D350798ad850F255Cb093D1be46Cc0B163",
    "drugRegistry":     "0xe9260db65A5B62Ccc09da4100c47F66dC39b4a6B",
    "areaRegistry":     "0x543513cea0Dfe318224508c5dD0E05298e776f44",
    "claims":           "0xaA6AfB0fCDB58135A12c06cD5b6D551A6507F14A",
    "multicall":        "0xF616a24AfC1C51B2514c5a7f63bcc792ac700F5b",
...
5. `DealersBoosts` — shop boost tiers
6. `DealersClaims` — achievements
7. `DealersMulticall` — bundled reads
8. `DEAreaRegistry` and `DEDrugRegistry` — economy reference data
9. `DealersRandomness` — commit-reveal coordinator
