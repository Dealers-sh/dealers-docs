...
Two properties are worth calling out because they shape strategy. The pot is fixed at settle, so the payout is pari-mutuel: more crew activity does not grow the pot, it dilutes each share. And qualification is all or nothing, because missing any single minimum threshold zeroes your entire score regardless of how much work you put in elsewhere.
