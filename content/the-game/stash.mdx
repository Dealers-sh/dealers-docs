...
| `INFAMY: n` | Your Steal-only score. Goes up on Steal wins, down on Steal losses. |
| `DEALS: nW/nT/nL` | Deal record: wins / ties / losses. |
| `STEALS: nW/nL` | Steal record as attacker: wins / losses. |
| `DEF: nW/nL` | Steal record as defender: times you survived a hit / times you got hit. |
