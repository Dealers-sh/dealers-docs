...
- **Black Market**: a shop run by a guy named Carl. Gated behind 10+ Infamy. The menu replaces drug deals with a single seller for exotic items earned from PVE — **Goods, Contraband, and Jewels** — at payouts well above normal sells.
...
Every action adds one heat, capped at 5. On every action the game rolls for arrest with chance equal to `heat × 0.5%`, so heat 5 is a 2.5% jail risk per action. 
